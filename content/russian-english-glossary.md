...
- [ ] привести главу 1 к виду как у срд (не один в один, но блоки вставок хотябы разместить как там)
...
Привет. Поможешь мне с переводом?

Так. Я перевожу starfinder second edition на русский и мне нужна твоя помощь. Я тебе дам словарь терминов, который нужно будет использовать. Нужно обращать внимание на регистр букв при переводе: если слово начинается с большой, его перевод тоже должен быть с большой. Не меняй форматирование текста. Старайся допускать минимум отклонений от исходного текста. Я буду кидать тебе куски текста, тебе нужно их переводить. Ничего кроме перевода в ответ присылать не нужно. Есть вопросы?

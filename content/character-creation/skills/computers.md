---
title: Компьютеры (Computers)
---
# Компьютеры (Computers)
*Интеллект*

Компьютеры отражают вашу способность работать с компьютерными системами и некоторым технологическим оборудованием. 

## Действия Компьютеров

### Нетренированные действия Компьютеров (Computers Untrained Actions)

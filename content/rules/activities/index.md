...
![[rules/activities/basic-actions/aid#Помощь (Aid) ↩|Помощь (Aid) ↩]]

![[rules/activities/basic-actions/crawl#Ползти (Crawl) ◆|Ползти (Crawl) ◆]]
...
![[rules/activities/basic-actions/specialty-basic-actions/arrest-a-fall#Остановить падение (Arrest a Fall) ↩|Остановить падение (Arrest a Fall) ↩]]
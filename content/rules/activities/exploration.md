...
[[rules/activities/all-activities/analyze-environment|Анализ Окружающей Среды (Analyze Environment)]]

[[rules/activities/all-activities/avoid-notice|Избегать обнаружения (Avoid Notice)]]

[[rules/activities/all-activities/defend|Защищаться (Defend)]]

[[rules/activities/all-activities/detect-magic|Обнаружение магии (Detect Magic)]]

[[rules/activities/all-activities/follow-the-expert|Повторять за экспертом (Follow the Expert)]]

[[rules/activities/all-activities/hustle|Спешить (Hustle)]]

[[rules/activities/all-activities/implant-augmentation|Имплантировать аугментацию (Implant Augmentation)]]

[[rules/activities/all-activities/install-upgrade|Установить улучшение (Install Upgrade)]]

[[rules/activities/all-activities/investigate|Исследовать (Investigate)]]
...
[[rules/activities/all-activities/scout|Разведывать (Scout)]]

[[rules/activities/all-activities/search|Искать (Search)]]

[[rules/activities/all-activities/sustain-an-effect|Поддержание эффекта (Sustain an Effect)]]

[[rules/activities/all-activities/decipher-writing|Расшифровка текста (Decipher Writing)]]

[[rules/activities/all-activities/identify-magic|Идентификация магии (Identify Magic)]]

[[rules/activities/all-activities/learn-a-spell|Выучить заклинание (Learn a Spell)]]

[[rules/activities/all-activities/squeeze|Протиснуться (Squeeze)]]

[[rules/activities/all-activities/borrow-an-arcane-spell|Одолжить арканное заклинание (Borrow an Arcane Spell)]]
...
[[rules/activities/all-activities/repair|Ремонт (Repair)]]
...
[[rules/activities/all-activities/treat-wounds|Лечение ран (Treat Wounds)]]

...
Обычно в игру играют группой от четырех до семи игроков, один из которых выполняет роль ГМ для всей группы. ГМ готовит, представляет и руководит обстановкой и сюжетом игры, создавая испытания и воплощая врагов, союзников и прохожих. По мере развития каждой сцены каждый игрок вносит свой вклад в историю, реагируя на ситуации в соответствии с личностью и способностями своего персонажа. В сочетании с заранее определенными показателями броски кубиков добавляют элемент случайности в игру и определяют, преуспевают или проваливаются персонажи в своих действиях.
...
Все, кто участвует в игре Starfinder, являются игроками, включая Ведущего (ГМ), но для простоты «игрок» обычно относится к участникам, отличному от ГМ. Перед началом игры игроки придумывают историю и личность своим персонажам, используя правила для определения показателей, способностей, сильных и слабых сторон своих персонажей. ГМ может ограничивать варианты, доступные игрокам во время создания персонажа, но эти ограничения должны быть обсуждены заранее, чтобы все могли создать интересных героев. В целом, единственными пределами для концепций персонажей являются воображение игроков и рекомендации ГМ.

Во время игры игроки описывают действия своих персонажей и бросают кости, используя способности своих персонажей. ГМ разрешает исход этих действий. Некоторые игроки любят отыгрывать (или изображать) то, что они делают, как будто они являются своими персонажами, в то время как другие описывают действия своих персонажей так, как если бы рассказывали историю. Делайте то, что вам больше всего нравится!

Если это ваш первый опыт в ролевой игре, рекомендуется взять на себя роль игрока, чтобы ознакомиться с правилами и галактикой.
...
**Кости**: Игрокам и Мастеру потребуется как минимум один комплект многогранных костей, хотя большинство участников приносят свои собственные. Шестигранные кости достаточно распространенные, но весь набор костей можно найти в местном магазине или онлайн.

**Приключение**: Каждой группе нужно приключение для игры, будь оно создано Мастером или найдено из числа опубликованных. Вы можете найти множество захватывающих приключений и даже целые кампании «Путь приключений» (Adventure Path) на сайте [paizo.com](https://paizo.com/).

**Starfinder Alien Core**: От передовых представителей Роя до чрезвычайно мощных драконов из звездного металла, монстры — это распространенная угроза, с которой могут столкнуться ПИ, и у каждого типа есть свои собственные показатели и умения. Эту информацию можно найти в ==Starfinder Alien Core==, бесценной книге для ГМ. Показатели монстров также доступны онлайн на paizo.com/prd.

**Карты и миниатюры**: Бывает тяжело представить хаос битвы, поэтому многие группы используют карты для визуализации поля боя. Эти карты размечены 1-дюймовой сеткой и каждый квадрат представляет 5 футов в игровом мире. Миниатюры и иллюстрированные токены, называемые «пешками» используются для обозначения персонажей и врагов, с которыми они сталкиваются.
...
Прежде чем создавать своего первого персонажа или приключение, вам следует понять ряд основных концепций, используемых в игре. Новые понятия выделены **жирным шрифтом**, чтобы их было легче найти, но эта глава — лишь введение в основы игры. Полные правила игры определены в последующих главах, а поиск поможет вам найти конкретные правила, которые вам нужны.

### Определение персонажей (Defining characters)

В Starfinder игроки берут на себя роль **персонажей игроков (ПИ)**, а Ведущий (ГМ) отыгрывает **неигровых персонажей (НИП)** и **монстров**. Хотя ПИ и НИП важны для сюжета, они служат очень разным целям в игре. ПИ — это главные герои — сюжет о них, а НИП — союзники, контакты, противники и злодеи. Тем не менее, у ПИ, НИП и монстров есть несколько общих черт.

**Уровень** — один из самых важных показателей игры, поскольку он показывает примерную силу и возможности каждого существа. У персонажей игроков варьируется от 1-го уровня в начале их приключенческой карьеры до 20-го уровня, пика могущества. По мере того как персонажи преодолевают трудности, побеждают врагов и завершают приключения, они накапливают **Очки опыта (XP)**. Каждый раз, когда персонаж набирает 1000 XP, он повышает уровень, получая новые способности, чтобы справляться с еще большими вызовами. ПИ 1-го уровня может сразиться с буйным ==сборным слизнем (assembly ooze)== или ==скампом из твердосвета (hardlight scamp)==, но на 20-м уровне тот же персонаж может уничтожить целую армию сверхмассивной черной дырой или обмениваться ударами с богом.

В дополнение к уровню, персонажей определяют **атрибуты**, которые измеряют исходный потенциал и используются для расчета большинства их других показателей. В игре шесть атрибутов: **Сила** представляет физическую мощь персонажа, а **Ловкость** — гибкость и умение избегать опасности. **Телосложение** указывает на общее здоровье и благополучие персонажа. **Интеллект** представляет общую образованность и умение решать проблемы, в то время как **Мудрость** измеряет проницательность персонажа и его умение оценивать ситуацию. Наконец, **Харизма** указывает на обаяние, убедительность и силу личности. Модификаторы показателей для обычных существ варьируются от -5 до +5, причем +0 представляет средние человеческие возможности. У персонажей высокого уровня модификаторы показателей могут быть намного выше +5. Модификатор атрибута выше среднего увеличивает ваши шансы на успех в связанных задачах, а ниже среднего — уменьшает их.

Вашего персонажа игрока также определяют некоторые ключевые выборы. Первый выбор — это **родословная** персонажа, представляющее родителей и наследие персонажа, такие как [[character-creation/all-ancestry-content/all-ancestries/barathu|барату]], [[character-creation/all-ancestry-content/all-ancestries/human|человек]] или [[character-creation/all-ancestry-content/all-ancestries/vesk|веск]]. Далее идет **предыстория** персонажа, которая описывает его воспитание, от хитрого [[character-creation/all-backgrounds/smuggler|контрабандиста]] до [[character-creation/all-backgrounds/icon|иконы]]. Наконец, и самое важное, **класс** персонажа определяет большинство его способностей и умений, такие как тренировка [[character-creation/all-classes-content/all-classes/soldier|солдата]] подавлять тяжёлым оружием или умение [[character-creation/all-classes-content/all-classes/witchwarper|исказителя]] изменять реальность.

В дополнение к этим ключевым выборам, у персонажей также есть ряд **способностей** — индивидуальных умений, выбираемых при создании персонажа и по мере повышения его уровня. У каждой способности есть тип, обозначающий местонахождение ее объяснения (например, [[character-creation/all-ancestry-content/all-ancestries/android#Способности родословной Андроид (Android Ancestry Feats)|способности андроидов]] можно найти в родословной [[character-creation/all-ancestry-content/all-ancestries/android|андроид]]) и тема (например, способности [[character-creation/all-classes-content/all-classes/mystic|мистика]] дают умения, связанные с заклинаниями). Наконец, у персонажей есть **навыки**, которые измеряют их умение оказывать первую помощь, использовать компьютеры, пилотировать транспортные средства и выполнять другие распространенные задачи.
...
Вылет из города на энеркоптере, обнаружение признаков марадёрствующего ==киокора (kyokor)==, предсказание пути, который киокор может проложить через безлюдные земли, и убеждение местных мусорщиков-изгоев помочь заманить монстра подальше от окраин города — всё это примеры того, что может произойти во время исследования.
...
**Свободные действия**, такие как бросание предмета, не входят в три действия, которые вы можете совершить за свой ход. Наконец, каждый персонаж может использовать до одной **реакции** за раунд. Этот особый тип действия можно использовать даже тогда, когда не ваш ход, но только в ответ на определенные события и только если у вас есть умение, позволяющее это. Например, [[character-creation/all-classes-content/all-classes/envoy|Посланники]] могут выбрать способность, которая позволяет им использовать свою реакцию для предупреждения союзника об атаке.

Атака другого существа — одно из самых распространенных действий в бою, и она выполняется с помощью действия [[rules/activities/all-activities/strike|Удар (Strike) ◆]]. Это требует броска на атаку — своего рода проверки, сделанной против **Класса Брони (AC/КБ)** существа, которое вы атакуете. Удары можно совершать с использованием оружия, заклинаний или даже частей тела существа, таких как коготь, кулак или хвост. Вы добавляете модификатор к этому броску на основе вашего ранга мастерства с типом атаки, который вы используете, ваши атрибуты и любые другие бонусы или штрафы в зависимости от ситуации. КБ цели рассчитывается на основе её ранга мастерства в надетой броне и модификатора Ловкости. Атака наносит урон, если она попадает, а критический успех приводит к тому, что атака наносит двойной урон!

Вы можете использовать более одного действия [[rules/activities/all-activities/strike|Удар (Strike) ◆]] за свой ход, но каждый дополнительный удар после первого становится менее точным. Это отражается **штрафом множественной атаки**, который начинается с -5 для второго удара, но увеличивается до -10 для третьего. Существует много способов уменьшить этот штраф, и он сбрасывается в конце вашего хода.

Если ваш персонаж оказывается целью заклинания [[spells/all-spells/mind-skewer|Пронзание разума (Mind Skewer)]] или попадает под область огня от [[equipment/all-equipment/all-weapons/flamethrower|огнемета]], вам придется попытаться совершить **спасбросок**, представляющий умение вашего персонажа избегать опасности или иным образом выдерживать нападение на его разум или тело. Спасбросок — это проверка, предпринятая против КС заклинания или особого умения, нацеленного на вашего персонажа. Существует три типа спасбросков, и мастерство вашего персонажа в каждом из них многое говорит о том, что он может выдержать. **Стойкость (Fortitude)** используется, когда здоровье или жизненная сила вашего персонажа подвергаются нападению, например, от яда или болезни. **Рефлекс (Reflex)** требуется, когда ваш персонаж должен уклониться от опасности, обычно чего-то, что влияет на большую площадь, такого как выброс лиан от заклинания [[spells/all-spells/verdant-code|Цветущий код (Verdant Code)]] или огненный взрыв от гранаты. Наконец, **Воля (Will)** часто является вашей защитой против заклинаний и эффектов, которые нацелены на разум вашего персонажа, таких как заклинание [[spells/all-spells/phantasmal-fleet|Призрачный флот (Phantasmal Fleet)]] или [[spells/all-spells/vibe-check|Вайб чек (Vibe Check)]]. Для всех спасбросков успех уменьшает вредный эффект, а критический успех обычно означает, что ваш персонаж остается невредимым.

Атаки, заклинания, опасности и особые умения часто либо наносят **урон** персонажу, либо накладывают одно или несколько **состояний**, а иногда и то, и другое. Урон вычитается из **Очков Здоровья (HP/ОЗ)** существа — меры здоровья — и когда у существа остается 0 HP, оно теряет сознание и может умереть! Боевая встреча обычно длится до тех пор, пока одна сторона не будет побеждена, и хотя это может означать отступление или капитуляцию, часто это происходит потому, что одна сторона мертва или [[rules/conditions/dying|при смерти]]. Состояния могут ограничивать существо в течение некоторого времени, ограничивая действия, которые оно может использовать, и применяя штрафы к будущим проверкам. Некоторые состояния даже постоянны, требуя от персонажа поиска мощной магии или передовых технологий для снятия их эффектов.

### Отдых (Downtime)

Персонажи не обязательно проводят каждое бодрствование в приключениях. Они также могут восстанавливаться от ран, изготавливать специальные товары, исследовать новое место и вербовать союзников, просматривать инфосферу или работать на подработке. В Starfinder это называется отдых, и он позволяет времени быстро проходить, пока персонажи работают над долгосрочными задачами или целями. Большинство персонажей могут работать во время отдыха, [[rules/activities/all-activities/earn-income|зарабатывая несколько кредитов]], но те, у кого есть подходящие навыки, также могут потратить время на [[rules/activities/all-activities/craft|изготовление]] или изобретение нового оборудования. Персонажи также могут использовать отдых для [[rules/player core/chapter-8-playing-the-game#Переобучение (Retraining)|переобучения]], заменяя один выбор персонажа другим, чтобы отразить их меняющиеся приоритеты. Они также могут исследовать проблему, изучать новые заклинания, наслаждаться ночной жизнью города или даже командовать звездным флотом или управлять космической станцией! Отдых может быть разделён между сценами ролевой игры, обсуждением долгосрочных планов вашего персонажа (или группы) и проверками навыков, предназначенными для представления дней или недель прогресса в достижении этих целей.

#### Ключевые понятия (Key terms)

Есть ряд важных терминов, которые вам нужно будет знать, когда вы создадите своего первого персонажа или приключение. Некоторые из наиболее важных терминов, упомянутых ранее, также включены здесь для справки.

##### Действие (Action)

Во время столкновений у каждого существа есть три действия в свой ход. Эти действия тратятся на атаку, взаимодействие с предметами, перемещение и использование особых умений. Доступные всем персонажам действия можно найти в [[rules/player core/chapter-8-playing-the-game#Простые действия (Basic Actions)|главе 8]].

##### Родословная (Ancestry)

Родословная — это род существ, к которым принадлежит персонаж. Родословная определяет начальные Очки Здоровья персонажа, языки, [[rules/player core/chapter-8-playing-the-game#Чувства (Senses)|чувства]] и [[rules/player core/chapter-8-playing-the-game#Скорость (Speed)|Скорость]], а также предоставляет доступ к способностям родословной. Родословные можно найти в [[rules/player core/chapter-2-ancestries-and-backgrounds|главе 2]].
...
Когда существо пытается навредить другому существу, оно совершает [[rules/activities/all-activities/strike|Удар (Strike) ◆]] или использует другое атакующее действие. Большинство атак — это удары оружием, но персонаж может ударить кулаком, схватить или толкнуть своими конечностями или атаковать заклинанием.
...
Когда персонаж пытается выполнить действие, успех которого не определен, он может бросить проверку. Это бросок одного двадцатигранного куба плюс указанный бонус мастерства. Например, проверка Восприятия добавит ваше мастерство Восприятия.
...
Непрерывный эффект, который меняет то, как персонаж может действовать или который изменяет некоторые из его показателей, называется состоянием. Правила для основных состояний, используемых в игре, можно найти в разделе [[rules/player core/conditions-appendix|Приложение состояний (Conditions Appendix)]].
...
Starfinder разворачивается в Мирах Пакта, системе союзных планет, которая когда-то была домом для потерянного мира Голарион, хотя многие приключения исследуют более широкую галактику. Больше информации о галактике можно найти на в разделе [[rules/player core/chapter-1-introduction#Исследование Галактики (Exploring The Galaxy)|Исследование Галактики]], в Starfinder Galaxy Guide и ==Starfinder GM Core==.
...
В начале столкновения все участвующие существа бросают инициативу, чтобы определить порядок их действий. Чем выше результат его броска, тем раньше существо может действовать. [[rules/player core/chapter-8-playing-the-game#Этап 1 Бросок инициативы (Roll Initiative)|Инициатива]] и [[rules/player core/chapter-8-playing-the-game#Режим столкновения (Encounter Mode)|бой]] описаны в [[rules/player core/chapter-8-playing-the-game|главе 8]].

##### Уровень (Level)

Уровень — это число, которое измеряет общую мощь чего-либо. У персонажей игроков есть уровень, варьирующийся от 1-го до 20-го, что представляет их уровень опыта. У монстров, НИП, опасностей, болезней и ядов есть уровни от -1 до 30, которые измеряют опасность, которую они представляют. Уровень предмета, обычно в диапазоне от 0 до 20, но иногда выше, указывает на его мощность и пригодность в качестве сокровищ.
...
Восприятие измеряет умение вашего персонажа замечать скрытые предметы или необычные ситуации, и обычно определяет, насколько быстро персонаж бросается в бой. Описано подробно [[rules/player core/chapter-8-playing-the-game#Восприятие и обнаружение (Perception and Detection)|здесь]].
...
Мастерство — это система, которая измеряет пригодность персонажа для конкретной задачи или качества, и имеет пять рангов: нетренирован, тренирован, эксперт, мастер и легенда. Мастерство дает вам бонус, который добавляется при определении следующих модификаторов и показателей: КБ, броски атаки, Восприятие, спасброски, навыки и эффективность заклинаний. Если вы нетренированы, ваш бонус мастерства равен +0. Если вы тренированы, эксперт, мастер или легенда, ваш бонус мастерства равен вашему **уровню** плюс 2, 4, 6 или 8 соответственно.

##### Редкость (Rarity)

Некоторые элементы игры имеют редкость, чтобы обозначить, как часто они встречаются в игровом мире. Редкость в основном применяется к снаряжению и магическим предметам, но также распространяется на заклинания, способности и другие элементы правил. Если признак элемента не указывает на его редкость, то он считается [[rules/traits/common|обычным]]. [[rules/traits/uncommon|Необычные]] варианты доступны только тем, у кого есть специальная подготовка, выросли в определенной культуре или родом из определенной части галактики. Это можно объяснить с помощью записи «Доступ», которая описывает критерии для персонажей, чтобы выбрать ее как обычный вариант. [[rules/traits/rare|Редкие]] варианты трудно найти и обычно выдаются только ГМ, а [[rules/traits/unique|уникальные]] — это буквально единственные в своем роде в игре. ГМ может изменить механизм работы редкости или изменить редкость отдельных предметов, чтобы соответствовать сюжету, который он хочет рассказать.
...
Навык представляет собой умение существа выполнять определенные задачи, требующие инструкций или практики. Все персонажи тренированы определенным навыкам благодаря своей предыстории и классу. Навыки подробно описаны в [[rules/player core/chapter-4-skills|главе 4]]. Каждый навык включает способы использования этого навыка кем угодно, даже если он нетренирован этому навыку, а также способы использования, которые требуют от персонажа тренированности этому навыку.
...
Заклинания — это магические эффекты, создаваемые путем произнесения мистических заклинаний и жестов. [[rules/activities/all-activities/cast-a-spell|Сотворение заклинания]] — это активность, которая обычно использует два действия. Каждое заклинание указывает, на что оно нацелено, какие действия необходимы для его применения, каковы его эффекты и как ему можно противостоять. Если класс предоставляет заклинания, то основы этого умения приводятся в описании класса в [[rules/player core/chapter-3-classes|главе 3]], а сами заклинания подробно описываются в [[rules/player core/chapter-7-spells|главе 7]].
...
Все признаки, используемые в этой книге, перечислены [[rules/traits/index|здесь]].
...
В качестве примера, чтобы дать вам лучшее представление о том, как играется Starfinder, представлен следующий случай. В этом приключении Терстон — ГМ. Дженни играет Обозаю, агрессивного [[character-creation/all-classes-content/all-classes/soldier|солдата]]-[[character-creation/all-ancestry-content/all-ancestries/vesk|веска]]; Джессика играет Даэ, эффектного [[character-creation/all-ancestry-content/all-ancestries/pahtra|патра]]-[[character-creation/all-classes-content/all-classes/solarian|солариана]]; Майк берет на себя роль Земира, [[character-creation/all-ancestry-content/all-ancestries/human|человека]]-[[character-creation/all-classes-content/all-classes/witchwarper|исказителя]], который видел всё во всех реальностях; а Дастин играет за Чк Чк, меланхоличного [[character-creation/all-ancestry-content/all-ancestries/shirren|ширрена]]-[[character-creation/all-classes-content/all-classes/mystic|мистика]], поклоняющегося [[setting/all-deities/zon-shelyn|Зон-Шелин]]. Партия решила отправить свой звездолет для расследования беспорядков возле Потокового маяка.
...
**Терстон**: Брось проверку [[character-creation/skills/piloting|Пилотирования]].  
...
**Чк Чк (Дастин)**: Я делаю драматическое чтение стихотворения, которое я написал о том, как найти вдохновение в неудаче, через наш [[character-creation/all-classes-content/all-classes/mystic#Групповой чат (Group Chat) (3-й)|групповой чат]].

> [!hint] 
> [[character-creation/all-classes-content/all-classes/mystic#Групповой чат (Group Chat) (3-й)|Групповой чат]] — это умение мистика, которое позволяет Чк Чк и любому в его связи телепатически общаться друг с другом. Большая часть разговоров происходит в Групповом чате.

**Земир (Майк)**: "Спасибо, Чк Чк." Я выпиваю кофе и пытаюсь снова. 13! У меня +7 к Пилотированию, это 20!  
**Терстон**: Корабль безопасно проносится сквозь обломки, пока маяк, к которому вас отправили, не появляется в смотровом окне. Это цилиндрический серебряный спутник размером в два раза больше вашего корабля, освещенный мигающими красными огнями, закрепленный в водовороте гиперпространства молитвами техносвященников [[setting/all-deities/triune|Триединого]].  
**Земир (Майк)**: Я подвожу корабль ближе, чтобы мы могли его осмотреть.  
**Терстон**: Приблизившись, вы замечаете бронированного [[character-creation/all-ancestry-content/all-ancestries/ysoki|Исоки]], цепляющегося за бок спутника.  
...
**Даэ (Джессика)**: Мне это не нравится. "Эй Обо, могу я одолжить твой [[equipment/all-equipment/all-upgrades/jetpack|реактивный ранец]]?"  
**Обозая (Дженни)**: "Только если ты его не сломаешь."  
**Терстон**: Даэ, ты устанавливаешь реактивный ранец Обозаи в свою броню?  
**Обозая (Дженни)**: Не лезь! Я сделаю это с [[feats/all-feats/quick-install|Быстрой установкой]].  

> [!hint] 
> [[feats/all-feats/quick-install|Быстрая установка (Quick Install)]] — это способность навыка, которая позволяет Обозае [[rules/activities/all-activities/install-upgrade|Установить улучшение (Install Upgrade)]] за 1 минуту вместо обычных 10 минут, которые потребовались бы для этой активности. 

**Даэ (Джессика)**: Я направляюсь к шлюзу и принимаю позу, когда выхожу в космос. "Эй Чк Чк, убедись, что ты это записываешь!"  
**Терстон**: Теперь ты [[rules/conditions/untethered|дрейфуешь]]. Ты свободно плаваешь?  
**Даэ (Джессика)**: Нет! Я активирую реактивный ранец и лечу к исоки.  
**Обозая (Дженни)**: "Осторожно, Даэ. Не хочу, чтобы мне пришлось отчищать тебя с поверхности Потокового маяка."  
...
**Терстон**: Даэ, подойдя ближе, ты замечаешь, что скафандр исоки покрыт кровью, и на шлеме трещина. Под ним лицо застыло в маске ужаса.  
**Земир (Майк)**: "Даэ, пришло время вернуться на корабль."  
**Даэ (Джессика)**: "Ты не должен мне говорить дважды, Зи!" Я хватаю исоки и тащу его обратно на корабль.  
**Терстон**: Даэ, когда ты возвращаешься к шлюзу, ты замечаешь кровяные разводы на полу, которых не было, когда ты уходила.  
**Даэ (Джессика)**: "Внимание. Думаю, что-то попало на корабль." Я оставляю исоки в шлюзе и бегу к мостику.  
**Терстон**: Даэ останавливается в 60 футах от двери на мостик. Остальные слышат приглушенный скрежет снаружи. Звучит так, будто что-то лезет к тебе.  
**Обозая (Дженни)**: Я достаю свой [[equipment/all-equipment/all-weapons/machine-gun|пулемет]] и встаю перед своими союзниками, лицом к двери. Ну давай.  
**Земир (Майк)**: Я поднимаюсь с пилотской консоли и выхватываю [[equipment/all-equipment/all-weapons/laser-pistol|лазерный пистолет]].  
**Чк Чк (Дастин)**: Я вытаскиваю свою [[equipment/all-equipment/all-weapons/painglaive|боль-глефу]] и проверяю свои узы, чтобы убедиться, что Даэ в безопасности.  

> [!hint] 
> Даэ является частью [[character-creation/all-classes-content/all-classes/mystic#Узы мистика (Mystic Bond)|уз мистика]] Чк Чка, поэтому он знает, что Даэ жива и не далеко. 
...
> [!hint] 
> Все бросают Восприятие для определения Инициативы. У Майка получилось 20. Джессика выбросила 12, Дастин — 16, а у Дженни выпало 10. У Терстона вышло 19 и 14 при броске за ==мертвеца потока (driftdead)==. Он тайно бросает за исоки в шлюзовой камере и получает 13. Терстон записывает все эти результаты, расставляя их по убыванию от наибольшего к наименьшему. У двух персонажей игроков есть способности, которые активируются при определении Инициативы. [[rules/activities/all-activities/quantum-pulse|Квантовый импульс (Quantum Pulse) ◇]] Земира позволяет ему активировать свое [[character-creation/all-classes-content/all-classes/witchwarper#Квантовое поле (Quantum Field)|квантовое поле]] — область искаженной реальности, которой он управляет. Он решает расположить его центр между врагом и собой. [[rules/traits/solarian|Соларианы]] могут [[rules/activities/all-activities/attune|Сонастроиться (Attune) ◆]] свободным действием при определении Инициативы, поэтому Даэ выбирает стать гравитон-сонастроенной и проявляет свое [[character-creation/all-classes-content/all-classes-options/solar-weapon|Солнечное оружие (Solar Weapon)]] — [[equipment/all-equipment/all-weapons/battle-ribbon|боевую ленту]] потрескивающую энергией [[rules/traits/void|пустоты]]. 

**Терстон**: Майк, ты первый.  
**Земир (Майк)**: Отлично. Для своего первого действия я трачу 1 Очко Фокусировки, чтобы сотворить [[spells/all-focuses/warp-terrain|Искажение местности (Warp Terrain)]].  
**Терстон**: Какой эффект ты выбираешь?  
**Земир (Майк)**: Я выбираю [[rules/player core/chapter-8-playing-the-game#Сложная местность (Difficult Terrain)|сложную местность]]. Мое квантовое поле заполняется скрученным металлом и кусками камней из реальности, где мы не прошли мимо этого астероида благополучно. Для своего следующего действия я стреляю в веска лазерным пистолетом!

> [!hint] 
> Майк бросает 12 и добавляет +8 из-за тренированности Майка [[rules/player core/chapter-6-equipment#Группа (Group (weapon))|Глава 6. Снаряжение (Equipment)]] [[rules/player core/chapter-6-equipment#Категории оружия (Weapon Categories)|простому]] оружию, что дает общий результат 20. Терстон сверяется со своими записями, чтобы убедиться, что у ==мертвеца потока(driftdead)== КБ 16. 

**Терстон**: Ты попал! Брось кость урона.  

> [!hint] 
> Майк бросает 2d6 для своего тактического лазерного пистолета и наносит 7 огненного урона, затем отмечает расходование 1 заряда из [[rules/player core/chapter-6-equipment#Магазин (Magazine)|магазина]] его оружия. 

**Земир (Майк)**: Для моего третьего действия я выполняю [[rules/activities/all-activities/take-cover|Укрыться (Take Cover) ◆]] за камнем в моем квантовом поле.  
**Терстон**: Гниющий веск отшатывается, когда лазерный огонь попадает в него, затем он стреляет зарядом энергии пустоты в тебя.  

> [!hint] 
> Терстон бросает 22. Класс Брони Земира — 21, но он получает бонус обстоятельства +2 за [[rules/player core/chapter-8-playing-the-game#Укрытие (Cover)|стандартное укрытие]]. Атака не попадает. ==Мертвец потока (driftdead)== стреляет еще одним зарядом в него. Терстон бросает 23, что попадает по Классу Брони Земира 21, и он получает 6 урона энергией пустоты. Затем ==мертвец потока== ковыляет к Обозае. Каждый квадрат [[rules/player core/chapter-8-playing-the-game#Сложная местность (Difficult Terrain)|сложной местности]] считается дважды, поэтому Скорости ==мертвеца потока== 25 футов недостаточно, чтобы добраться до нее в этом раунде.

**Чк Чк (Дастин)**: Я произношу заклинание [[spells/all-spells/vibe-check|Вайб чек (Vibe Check)]]. Я передаю гневное стихотворение о моем детстве в разум человека: «Несмотря на всю мою желчь, я все еще просто насекомое во флаконе!» Это два действия. Затем я выполняю [[rules/activities/all-activities/transfer-vitality|Перенос витальности (Transfer Vitality) ◆]] Земиру и исцелю его на 7 Очков Здоровья.  
...
**Чк Чк (Дастин)**: «Я приветствую боль!» Да, это попадает в меня.  

> [!hint] 
> Терстон бросает урон от рубящих ударов когтей ==мертвеца потока== и получает общий результат 10. 

**Даэ (Джессика)**: Мой ход! Я совершаю [[feats/all-feats/stellar-rush|Звёздный натиск (Stellar Rush) ◆◆]] по коридору и на мостик. Черный разряд трещит вокруг меня и тянет обоих врагов к себе, когда я проношусь мимо них.  

> [!hint] 
> [[feats/all-feats/stellar-rush|Звёздный натиск (Stellar Rush) ◆◆]] — это способность [[character-creation/all-classes-content/all-classes/solarian|солариана]], которая позволяет Даэ совершить два [[rules/activities/all-activities/stride|Перемещения (Stride) ◆]] с бонусом обстоятельства +10 к скорости передвижения. Когда Даэ завершает оба Перемещения, враги в пределах 15 футов пытаются пройти Спасбросок Стойкости, чтобы определить, будут ли они притянуты к Даэ. КС Даэ - 21. Терстон бросает за обоих ==мертвецов потока== и получает 6 и 12. Оба проваливают проверку и притягиваются к Даэ, заканчивая в смежных квадратах. [[feats/all-feats/stellar-rush|Звёздный натиск (Stellar Rush) ◆◆]] имеет признак [[rules/traits/cycle|цикл]], что означает, что сонастройка Даэ меняется на фотонную после завершения действия. 
...
**Обозая (Дженни)**: «Спасибо за подготовку, Даэ!» Я использую [[rules/activities/all-activities/auto-fire|Автоматический огонь (Auto-Fire) ◆◆]] на обоих врагов. Человек ближе ко мне, поэтому она является моей [[character-creation/all-classes-content/all-classes/soldier#Приоритетная цель (Primary Target)|приоритетной целью]].

> [!hint] 
> [[rules/activities/all-activities/auto-fire|Автоматический огонь (Auto-Fire) ◆◆]] Обозаи попадает по всем существам в конусе радиусом 20 футов, включая Даэ, но благодаря тренированности от ее боевого стиля [[character-creation/all-classes-content/all-classes-options/bombard|Артиллерист (Bombard)]] она избегает причинения вреда союзнику. Вместо того чтобы Обозая бросала [[rules/activities/all-activities/strike|Удар (Strike) ◆]], существа в области поражения проходят Спасбросок Рефлекса, чтобы узнать, сколько урона они получают. ==мертвец потока== веск успешно проходит спасбросок и получает 9 урона - ровно столько, чтобы вывести его из строя! Другой проваливает проверку и получает 18 урона от обстрела. 

**Обозая (Дженни)**: «Ха-ха-ха-ха!» Это [[feats/all-feats/menacing-laughter|Зловещий cмех (Menacing Laughter) ◆]] для моего третьего действия. О, и не забудьте, враг [[rules/conditions/suppressed|подавлен]].

> [!hint] 
> Обозая бросает проверку Запугивания, добавляя свой модификатор +11. Она бросила 1, поэтому ==мертвец потока== не потрясен. ==мертвец потока== [[rules/conditions/suppressed|подавлен]] атакой Обозаи, получая штраф обстоятельства -1 к броскам на атаку и штраф состояния -10 футов к Скорости до начала своего следующего хода. 
...
В этой [[rules/player core/chapter-3-classes|главе]] содержатся правила для 6 классов. В каждом описании класса приведены рекомендации по игре этим классом, правила создания и повышения уровня персонажа этого класса, примеры билдов и все способности класса, доступные этому классу. В конце этой главы находятся правила для архетипов — специальных опций, доступных персонажам при повышении их уровня. Эти правила позволяют персонажу немного погрузиться в способности другого класса или концепции.
...
По мере повышения уровня персонажа он получает дополнительные способности, чтобы представить свои растущие возможности. Общие способности и способности навыков (которые являются подмножеством общих способностей) представлены в этой [[rules/player core/chapter-5-feats|главе]].

### Глава 6: Снаряжение (Equipment)

Броня, оружие и другое снаряжение можно найти в этой [[rules/player core/chapter-6-equipment|главе]], а также цены на услуги, стоимость проживания и транспорт (например, аэротакси и гравипоезда).

### Глава 7: Заклинания (Spells)

Эта [[rules/player core/chapter-7-spells|глава]] начинается с правил применения заклинаний, определения их эффектов и нейтрализации заклинаний противников (называемых противодействием). После этого представлены списки заклинаний для каждой традиции заклинателей, что позволяет быстро найти заклинания по их рангу. Далее следуют правила для каждого заклинания, представленные в алфавитном порядке. За описаниями заклинаний находятся все заклинания фокусировки — специальные заклинания, даваемые определенными способностями и умениями класса. Хотя большинство заклинаний появляются в нескольких списках заклинаний, заклинания фокусировки предоставляются только членам конкретного класса и сгруппированы по классу для удобства справки. Наконец, в конце главы находятся правила для ритуалов — сложных и рискованных заклинаний, которые может попытаться сотворить любой персонаж.

### Глава 8: Ведение игры (Playing the game)

Эта важная [[rules/player core/chapter-8-playing-the-game|глава]] содержит универсальные правила, необходимые для игры в Starfinder, включая правила для различных режимов игры, основные действия, которые может выполнять каждый персонаж, правила боя и правила смерти и умирания. Каждый игрок должен быть знаком с этой главой, особенно ГМ (Ведущий).

### Приложения (Appendices)

В конце этой книги находится [[rules/player core/conditions-appendix|приложение]] с правилами для всех состояний, которые вы найдете в игре. Этот раздел также включает пустой лист персонажа и индекс с исчерпывающим глоссарием распространенных терминов и признаков, с которыми вы столкнетесь в игре.
...
Starfinder использует множество терминов, которые обычно выражаются в виде аббревиатур, таких как КБ для Класса Брони, КС для класса сложности и ОЗ для Очков Здоровья. Если вы когда-либо запутаетесь в игровом термине или аббревиатуре, вы всегда можете обратиться к Поиску.

#### Примечание для формата правил на сайте

Если что-либо относится к элементам правил, чаще всего оно выделено ссылкой на этот самый [[rules/player core/chapter-1-introduction#Примечание для формата правил на сайте|элемент правил]] или «кавычками». Если на что то подразумевается ссылка, но её пока нет, текст выделен ==следующим образом==.
...
Все задачи, занимающие больше одного хода, являются активностями. Если активность предназначена для выполнения в режиме исследования, она имеет признак [[rules/traits/exploration|исследование]]. Активность, требующая дня или более и которая может быть выполнена только во время отдыха, имеет признак [[rules/traits/downtime|отдых]].

### Чтение правил (Reading rules)

В этой книге содержится множество элементов правил, которые дают персонажам новые и интересные способы реагировать на ситуации в игре. Все персонажи могут использовать [[rules/player core/chapter-8-playing-the-game#Простые действия (Basic Actions)|простые действия]], описанные в [[rules/player core/chapter-8-playing-the-game|главе 8]], но у отдельного персонажа часто есть специальные правила, позволяющие им делать то, чего большинство других персонажей не могут. Большинство этих возможностей предоставляются способностями, которые приобретаются при определенных выборах во время создания персонажа или когда персонаж повышает свой уровень.

Независимо от игровой механики, которую они передают, элементы правил всегда представлены в виде блока показателей — сводки правил, необходимой для оживления монстра, персонажа, предмета или другого элемента правил во время игры. При необходимости, правила сопровождаются объяснением их формата. Например, раздел «Родословные» в [[rules/player core/chapter-2-ancestries-and-backgrounds|главе 2]] содержит правила для десяти родословных в этой книге и объяснение разделов родословной указано в начале этой главы.

Общий формат блока показателей приведен ниже. Элементы не включаются в блок показателей, если они неприменимы, поэтому не все элементы правил будут иметь каждый из перечисленных ниже элементов. Действия, реакции и свободные действия имеют соответствующий значок рядом со своим названием для обозначения их типа. Активность, которую можно выполнить за один ход, имеет символ, указывающий на количество необходимых действий; активности, требующие больше времени для выполнения, не содержат этих значков. Если персонаж должен достичь определенного уровня, прежде чем получить доступ к умению, этот уровень указан справа от блока показателей. Правила также часто имеют признаки, связанные с ними (признаки появляются в Словаре и Указателе).

Заклинания, технологические предметы и магические предметы используют схожий формат, но их блоки показателей содержат ряд уникальных элементов, таких как возможные магические традиции для заклинания (см. [[rules/player core/chapter-7-spells|Глава 7]] для получения дополнительной информации о чтении заклинаний).

> [!summary] Название действия или способности (оригинальное название) ◆
> [Признак 1]  
> 
> **Источник** Источника действия или способности
> **Уровень** уровень  действия или способности
...
Если вы не ГМ, первое, что вам нужно сделать в игре Starfinder — создать своего персонажа. Именно вам решать, как представить прошлый опыт, личность и взгляд на галактику вашего персонажа, и это задаст тон для вашего ролевого отыгрыша во время игры. Вы будете использовать игровые механики, чтобы определить умения вашего персонажа выполнять различные задачи и использовать особые умения.
...
Если вы создаете персонажа высокого уровня, то будет хорошей идеей начать с инструкций этого раздела, а потом перейти в раздел про [[rules/player core/chapter-1-introduction#Повышение уровня (Leveling Up)|Повышение уровня (Leveling Up)]] персонажа.
...
На [[rules/player core/chapter-1-introduction#Шаг 3. Выберите родословную (Select an ancestry)|Шаге 3. Выберите родословную]] и [[rules/player core/chapter-1-introduction#Шаг 5. Выберите класс (Choose a class)|Шаге 5. Выберите класс]] вы увидите наглядное представление родословных и классов соответственно, которое даёт краткую информацию для игроков, стремящихся максимально использовать свои начальные модификаторы атрибутов. В обзоре родословных на [[rules/player core/chapter-1-introduction#Шаг 3. Выберите родословную (Select an ancestry)|Шаге 3]] каждая запись указывает, какие модификаторы атрибутов она повышает, а также отмечает любые понижения атрибутов, которые может иметь родословная. Больше информации о повышениях и понижениях атрибутов вы можете найти в боковой панели [[rules/player core/chapter-1-introduction#Обзор модификаторов атрибутов (Attribute modifier overview)|Обзор модификаторов атрибутов (Attribute Modifier Overview)]].

Сводки классов на [[rules/player core/chapter-1-introduction#Шаг 5. Выберите класс (Choose a class)|Шаге 5]] перечисляют ключевой атрибут каждого класса — модификатор атрибута, который используется для вычисления силы многих их особенностей класса. Персонажи получают повышение атрибута в своём ключевом атрибуте при выборе класса. В этом обзоре также указываются один или несколько второстепенных модификаторов атрибутов, важных для представителей этого класса.

Предыстория персонажа также влияет на его модификаторы атрибутов, хотя в повышениях атрибутов от предысторий больше гибкости, чем в повышениях от классов. Для описаний предысторий см. [[character-creation/backgrounds|Предыстории (Backgrounds)]].

## Шаг 1. Создание концепции (Create a concept)

Какого типа персонажа вы хотите играть? Ответ на этот вопрос может быть таким простым, как «пилот звездолета», или таким сложным, как «ведающий [[character-creation/all-ancestry-content/all-ancestries/kasatha|касата]], воспитанный на корабле-колонии далеко от родной планеты, преданный [[setting/all-deities/talavet|Талавет]], богине общины и традиций». Рассмотрите личность вашего персонажа, наметьте несколько деталей из его прошлого и подумайте о том, как и почему он отправляется в приключения. Вам стоит изучить доступные [[character-creation/ancestries|родословные]], [[character-creation/backgrounds|предыстории]] и [[character-creation/classes|классы]] Starfinder. Краткие обзоры ниже могут помочь вам сопоставить вашу концепцию с некоторыми из этих базовых элементов правил. Перед началом игры также полезно, чтобы игроки обсудили, как их персонажи могут знать друг друга и как они будут работать вместе в течение своих приключений.
...
Как только у вас появится хорошее представление о том, какого персонажа вы хотите играть, переходите к [[rules/player core/chapter-1-introduction#Шаг 2. Билд Модификаторов Атрибутов (Start building attribute modifiers)|Шагу 2]], чтобы начать создавать своего персонажа.
...
Возможно, вы хотите сыграть персонажа, который является набожным последователем конкретного божества. Народы галактики исповедуют бесчисленные верования и философии, охватывающие широкий пантеон, от [[setting/all-deities/damoritosh|Даморитоша]], Завоевателя, бога долга, войны и родового покровителя Вескариума; до [[setting/all-deities/eloritu|Элориту]], Скрытой Истины и бога истории, магии и секретов; до [[setting/all-deities/oras|Ораса]], Агента Перемен, бога эволюции и трансформации посредством науки. Основные божества Starfinder представлены на в разделе [[setting/deities|Божества (Deities)]]. Ваш персонаж может быть настолько притянут к определенной вере, что вы решите сделать его [[character-creation/all-backgrounds/disciple|адептом]] или [[character-creation/all-classes-content/all-classes/mystic|мистиком]] этого божества; он также может быть рядовым верующим, применяющим учения своей веры в повседневной жизни, или скептиком, проклятым благословением церкви.
...
> Как только вы разработаете концепцию своего персонажа, запишите несколько предложений, обобщающих ваши идеи, в раздел «Примечания (Notes)» на третьей странице листа персонажа. Запишите любые детали, которые вы уже решили, такие как имя вашего персонажа, в соответствующие строки на первой странице. 
...
Совершенствование модификатора атрибута улучшает проверки и показатели, связанные с этим умением, как описано ниже. Продумывая своего персонажа, вы также должны решить, на каких модификаторах атрибутов вам следует сосредоточиться, чтобы у вас были наилучшие шансы на успех.

##### Сила (Strength)

Сила измеряет физическую мощь вашего персонажа и важна, если ваш персонаж планирует участвовать в ближнем бою. Модификатор Силы добавляется к броскам урона в ближнем бою и определяет, сколько может [[rules/player core/chapter-6-equipment#Ограничения Массы (Bulk Limits)|нести]] ваш персонаж.
...
**Родословная**: Каждая родословная даёт повышения атрибутов, а иногда и понижение атрибута. Если вы берёте какие-либо добровольные понижения, примените их на этом шаге (см. [[rules/player core/chapter-1-introduction#Опционально Добровольные недостатки (Optional Voluntary Flaws)|Добровольные недостатки]]).  
...
Понижения атрибутов встречаются в Starfinder гораздо реже, чем повышения атрибутов. Если у вашего персонажа есть понижение атрибута — вероятнее всего, из-за его родословной — вы уменьшаете соответствующий модификатор атрибута на 1. Например, [[character-creation/all-ancestry-content/all-ancestries/vesk|Вески]] получают понижение атрибута к Мудрости.

<sup>*</sup> Любой персонаж может выбрать два свободных повышения вместо указанных повышений и понижений ([[rules/player core/chapter-1-introduction#Альтернативные повышения атрибутов родословной (Alternate Ancestry Boosts)|Альтернативные повышения атрибутов родословной]]).

<sup>**</sup> Персонаж получает повышение атрибута к ключевому атрибуту своего класса.

## Шаг 3. Выберите родословную (Select an ancestry)

Выберите Родословную для вашего персонажа. [[rules/player core/chapter-1-introduction#Обзор Родословных|Обзор родословных]] предоставляет обзор основных вариантов Родословных Starfinder, и каждая из них подробно описана в [[rules/player core/chapter-2-ancestries-and-backgrounds|главе 2]]. Родословная определяет [[rules/player core/chapter-2-ancestries-and-backgrounds#Размер (Size)|размер]] вашего персонажа, Скорость и языки, а также влияет на его Очки Здоровья. Каждая также предоставляет повышения и понижения атрибутов, чтобы представить основные возможности Родословной.
...
- Распределите любые свободные повышения атрибутов и решите, берете ли вы какие-либо добровольные понижения атрибутов.
...
[[character-creation/all-ancestry-content/all-ancestries/android|Андроиды (Android)]] — это синтетические, созданные искусственно существа с разнообразной внешностью и происхождением.
...
[[character-creation/all-ancestry-content/all-ancestries/barathu|Барату (Barathu)]] — парящие, похожие на медуз обитатели газового гиганта, способные по собственной воле переписывать свой генетический код.
...
[[character-creation/all-ancestry-content/all-ancestries/human|Люди (Human)]] — чрезвычайно адаптивный и универсальный вид, который можно встретить почти на любом мире.
...
[[character-creation/all-ancestry-content/all-ancestries/kasatha|Касаты (Kasatha)]] — четырёхрукие переселенцы с умирающего мира, ценящие космический баланс и традиции.
...
[[character-creation/all-ancestry-content/all-ancestries/lashunta|Лашунты (Lashunta)]] — обаятельные телепаты с Кастровеля, известные своим уникальным диморфизмом.
...
[[character-creation/all-ancestry-content/all-ancestries/pahtra|Патры (Pahtra)]] — грациозные и состязательные, они ценят конкуренцию, музыку и собственную свободу.
...
[[character-creation/all-ancestry-content/all-ancestries/shirren|Ширрены (Shirren)]] — телепаты, ищущие смысл и мир после освобождения от коллективного разума Роя.
...
[[rules/traits/skittermander|Скиттермандеры (Skittermander)]] — по природе своей импульсивные помощники, готовые взяться за всё, что могут унести их шесть рук.
...
[[character-creation/all-ancestry-content/all-ancestries/vesk|Вески (Vesk)]] — гордые рептилоидные завоеватели с сильным желанием доказать свою силу честным путём.
...
[[character-creation/all-ancestry-content/all-ancestries/ysoki|Исоки (Ysoki)]] — гибкие и умом, и телом, использующие свои навыки на благо своих общин и семей.
...
[[character-creation/all-ancestry-content/all-ancestries/borai|Бораи (Borai)]] — трупы, воскрешённые собственными душами, одновременно живые и нежить.

##### Присмени (Prismeni)

[[character-creation/all-ancestry-content/all-ancestries/prismeni|Присмени (Prismeni)]] — существа, находящиеся под влиянием энергии гиперпространственного измерения, известного как Поток, и сами способны её контролировать.

> [!example] Лист персонажа
> Запишите родословную и наследие вашего персонажа в соответствующее поле в верхней части первой страницы листа персонажа. Скррректируйте модификаторы атрибутов, добавляя 1 к модификатору атрибута, если вы получили повышение атрибута от вашей родословной, и вычитая 1 из модификатора атрибута, если вы получили понижение атрибута от вашей родословной. Отметьте количество очков здоровья (ОЗ), которые ваш персонаж получает от своей родословной — позже вы добавите к этому числу еще очки. Наконец, в соответствующих полях запишите размер вашего персонажа, Скорость и языки. Если родословная вашего персонажа предоставляет ему особые умения, запишите их в соответствующие поля, например, [[rules/player core/chapter-8-playing-the-game#Ночное зрение и Сильное ночное зрение (Darkvision and Greater Darkvision)|Ночное зрение]] в раздел «Органы чувств» на первой странице и [[rules/player core/chapter-7-spells#Врожденные заклинания (Innate Spells)|врожденные заклинания]] на четвертой странице. Запишите выбранную вами способность родословной в раздел «Способность родословной (Ancestry Feat)» на второй странице листа персонажа. 

## Шаг 4. Выберите предысторию (Pick a background)

Предыстория вашего персонажа может представлять их воспитание, талант, который они оттачивали с юности, или другой аспект их жизни до того, как они стали искателем приключений. Предыстории персонажей представлены в [[rules/player core/chapter-2-ancestries-and-backgrounds|главе 2]], или в разделе [[character-creation/backgrounds|Предыстории (Backgrounds)]]. Обычно они предоставляют два повышения атрибутов (одно из которых можно применить к любому из двух конкретных модификаторов атрибутов, а другое — свободное), обучение определенному навыку, обучение навыку Знания и конкретную способность навыка.
...
[[character-creation/all-classes-content/all-classes/envoy|Посланник (Envoy)]] ведёт свою команду, используя вдохновляющие указания и хитроумные социальные навыки.
...
[[character-creation/all-classes-content/all-classes/mystic|Мистик (Mystic)]] укрепляет духовные узы между своими союзниками с помощью фундаментальной силы космоса.
...
[[character-creation/all-classes-content/all-classes/operative|Оперативник (Operative)]] — это высококвалифицированный специалист по огнестрельному оружию, наносящий удары с тактической точностью.
...
[[character-creation/all-classes-content/all-classes/solarian|Солариан (Solarian)]] — защитник космоса, владеющий оружием и силами, настроенными на гравитацию и свет.
...
[[character-creation/all-classes-content/all-classes/soldier|Солдат (Soldier)]] — мастер тяжёлого вооружения, защищающий союзников стеной огневой мощи.
...
[[character-creation/all-classes-content/all-classes/witchwarper|Исказитель (Witchwarper)]] — парадоксальный проводник, способный высвобождать бесконечные возможности мультивселенной.
...
- Затем примените четыре свободных повышения атрибутов к модификаторам атрибутов вашего персонажа. Выберите для каждого разный модификатор атрибута и увеличьте этот модификатор атрибута на 1.
...
- Ознакомьтесь с таблицей развития класса в описании вашего класса, чтобы узнать об особенностях класса, которые получает ваш персонаж на 1 уровне. Вы уже выбрали родословную, предысторию и свободные повышения атрибутов, но они перечислены в таблице как напоминание. Некоторые особенности класса требуют от вас сделать дополнительные выборы, такие как выбор заклинаний.

> [!example] Лист персонажа
> Запишите общее количество очков здоровья вашего персонажа на первой странице листа персонажа. Используйте поля владения навыками (поля, отмеченные «Т», «Э», «М» и «Л») на листе персонажа, чтобы записать начальное владение вашего персонажа Восприятием, спасбросками и навыками, предоставленными его классом; поставьте «Т», если ваш персонаж тренирован, или «Э», если он эксперт. Укажите дополнительные навыки, которые вы выбрали для своего персонажа, чтобы быть тренированным, отметив поле «Т» для каждого выбранного вами навыка. Также запишите мастерство брони вашего персонажа в разделе «Класс Брони» в верхней части первой страницы и его мастерство оружия внизу первой страницы. Запишите все остальные особенности и умения класса на второй странице. Пока не волнуйтесь об окончательных значениях показателей персонажа, вы разберетесь с этим на Шаге 9. 

## Шаг 8. Купите снаряжение (Buy equipment)

На первом уровне ваш персонаж имеет **150 кредитов**, чтобы потратить их на [[equipment/armor|броню]], [[equipment/weapons|оружие]] и другое простое [[equipment/adventuring-gear|снаряжение]]. Класс вашего персонажа перечисляет типы оружия и брони, которым он тренирован (или лучше!). Оружие определяет как много урона персонаж наносит в бою, а броня влияет на Класс Брони; эти расчёты более подробно раскрыты на Шаге 10.

Вам также понадобятся такие вещи, как [[equipment/all-equipment/all-items/cable-line|Трос (Cable Line)]], [[equipment/all-equipment/all-items/flashlight|Фонарик (Flashlight)]], комплекты инструментов и другое снаряжение для путешествий, а может быть даже [[equipment/medical-items|сыворотка или спрейплоть]] для неотложной медицинской помощи. [[equipment/augmentations|Аугментации]], изменяющие твое тело, [[equipment/upgrades|улучшения]] для брони и оружия, и [[equipment/magic-items|магические предметы]] — более дорогие варианты, которые вы, вероятно, пока не сможете себе позволить, но просмотр витрин бесплатен! Подробнее о доступном снаряжении и его стоимости смотрите в [[rules/player core/chapter-6-equipment|Главе 6]].
...
Когда большинство важных решений для вашего персонажа уже принято, пора вычислить модификаторы для каждого из следующих показателей. Если ваш ранг мастерства для показателя — тренирован, эксперт, мастер или легенда, ваш бонус равен уровню персонажа плюс число, зависящее от ранга (соответственно 2, 4, 6 и 8). Если персонаж нетренирован, его бонус мастерства равен +0.

### Восприятие (Perception)

Модификатор Восприятия вашего персонажа показывает, насколько он внимателен, и равен его бонусу мастерства в Восприятии плюс модификатор Мудрости. См. [[rules/player core/chapter-8-playing-the-game#Восприятие (Perception)|Восприятие]] для подробностей.
...
Рядом с тем местом, где вы записали оружие ближнего боя и оружие дальнего боя вашего персонажа, вычислите модификатор для совершения [[rules/activities/all-activities/strike|Удара (Strike) ◆]] каждым оружием и сколько урона наносит этот [[rules/activities/all-activities/strike|Удар (Strike) ◆]]. Модификатор для Удара равен бонусу мастерства вашего персонажа с этим оружием плюс модификатор атрибута (обычно Силы для Ударов ближнего боя и Ловкости для Ударов дальнего боя). Вы также добавляете любой бонус предмета от оружия и любые другие постоянные бонусы или штрафы. Вам также нужно вычислить, сколько урона наносит Удар этим оружием. Оружие ближнего боя обычно добавляет модификатор Силы вашего персонажа к броскам урона, тогда как оружие дальнего боя может добавлять часть или весь модификатор Силы вашего персонажа, в зависимости от признаков оружия. Смотрите раздел [[rules/player core/chapter-6-equipment#Оружие (Weapons)|оружие]] в Главе 6 для дополнительной информации.
...
Многие персонажи могут выучить несколько [[rules/player core/chapter-7-spells#Чары (Cantrips)|чар]] или [[rules/player core/chapter-7-spells#Заклинания фокусировки (Focus Spells)|заклинаний фокусировки]], но [[character-creation/all-classes-content/all-classes/mystic|мистики]] и [[character-creation/all-classes-content/all-classes/witchwarper|исказители]] получают колдовство — способность сотворять широкий спектр заклинаний. Если класс вашего персонажа предоставляет заклинания, вам следует на Шаге 7 уделить время изучению заклинаний, которые он знает, и того, как их сотворять. Четвёртая страница листа персонажа содержит место для указания [[rules/player core/chapter-7-spells#Магические традиции (Magical Traditions)|магической традиции]] вашего персонажа и его ранга мастерства для модификатора атаки заклинанием и КС заклинания. Там же есть место для записи заклинаний из репертуара вашего персонажа. Каждый класс определяет, какие именно заклинания и как может сотворять персонаж, но сами заклинания и подробные правила колдовства приведены в [[rules/player core/chapter-7-spells|Главе 7]].

### Эдикты и Анафемы (Edicts and Anathema)

Вы можете взять эдикты и анафемы, чтобы подчеркнуть убеждения своего персонажа и определить, как он будет реагировать в определённых ситуациях. **Эдикты** — это поведение, которое поощряется вашей личной философией или кодексом. **Анафемы** — это противоположное: действия, противоречащие вашей точке зрения и нарушающие ваш личный кодекс. Например, вы можете следовать эдикту вести записи о любой планете, которую посещаете, или считать анафемой удаление данных или сокрытие информации от общественности.

Для большинства персонажей это полностью необязательно, однако лучше подумать о том, чтобы взять их при создании персонажа, чтобы точнее определить его образ мышления. Если являетесь последователем какого-либо божества, вы можете черпать вдохновение из эдиктов и анафем, перечисленных для него в разделе [[setting/deities|Божества (Deities)]]. Описания родословных содержат эдикты и анафемы, распространённые среди их сообществ.

#### Изменение эдиктов и анафем (Changing Edicts and Anathema)

Эдикты и анафемы могут меняться в ходе игры по мере того, как убеждения персонажа эволюционируют, или когда вы понимаете, что действия персонажа отражают иной набор ценностей, чем вы предполагали раньше. В большинстве случаев вы можете просто изменить соответствующий эдикт или анафему и продолжить игру.

### Пристанище (Port of call)

Пристанище вашего персонажа — это место, где он проводит отдых между приключениями или которое принял как временный дом. Это может быть планета или космическая станция, на которой он проводит много времени, или даже корабль-колония вроде ==Идари==, где он сейчас живёт или который часто посещает.
...
Запишите божество, которому поклоняется ваш персонаж, если таковое есть. Ваш персонаж может поклоняться нескольким божествам как части личного пантеона. Вместо этого вы можете выбрать [[setting/deities#Веры и философии (Faiths and philosophies)|философию]] или решить, что ваш персонаж — [[setting/all-deities/atheism|атеист]]. См. [[setting/deities|Божества (Deities)]], чтобы узнать больше о божествах Starfinder.

### Возраст (Age)

Определите возраст персонажа и отметьте его на третьей странице листа персонажа. Вы можете играть персонажем любого возраста. Никаких механических изменений показателей персонажа в зависимости от возраста нет, но вы можете учитывать его при выборе стартовых модификаторов атрибутов и планировании будущего развития. Особенно молодые персонажи могут влиять на тон некоторых игровых моментов, так что рекомендуется чтобы они были хотя бы совершеннолетними взрослыми.
...
Джессика находит описание [[character-creation/all-ancestry-content/all-ancestries/shirren|ширрен]] в [[rules/player core/chapter-2-ancestries-and-backgrounds|главе 2]]. Она записывает повышения атрибутов к модификаторам Телосложения и Мудрости (повышая оба до +1). Она также применяет понижение атрибута к Харизме, снижая её до -1. В качестве свободного повышения атрибута она выбирает Силу, так как это ключевой атрибут для солариана и он помогает в ударах ближнего боя, повышая её тоже до +1. Она также записывает 10 Очков Здоровья, которые даёт родословная. Затем она возвращается к листу персонажа, чтобы записать размер, Скорость, язык и способность к ограниченной телепатии, которые она получает как ширрен. Наконец, она выбирает наследие, записывая [[character-creation/all-ancestry-content/all-heritages/defiant-shirren|Непокорный Ширрен (Defiant Shirren)]] рядом со словом «ширрен», и выбирает способность родословной — [[feats/all-feats/psychic-talent|Псионический талант (Psychic Talent)]], чтобы иметь возможность сотворять одни оккультные чары.

### Шаг 4

Просматривая предыстории, Джессике нравится идея бывалого бывшего агента Starfinder, который неохотно выходит из отставки, чтобы помочь обучить совершенно новую команду, и предыстория [[character-creation/all-backgrounds/recluse|Отшельник (Recluse)]] отлично подходит для этой роли. Для первого повышения атрибута, получаемого от предыстории, Джессика выбирает Телосложение (что даст её персонажу больше Очков Здоровья), а для свободного повышения атрибута — Силу (её ключевой атрибут для солариана), повышая оба до +2. На второй странице она записывает «[[feats/all-feats/dubious-knowledge|Сомнительные знания (Dubious Knowledge)]]» в разделе Навыков, в строке Предыстории. Наконец, вернувшись на первую страницу, она записывает «Starfinder» рядом с первой записью навыка Знания и отмечает окошко рядом с «T» для этого навыка и Навыка Выживания.

### Шаг 5

Джессика записывает «[[character-creation/all-classes-content/all-classes/solarian|солариан]]» в строке класса на листе персонажа и вписывает число 1 в поле уровня. Класс солариана даёт повышение атрибута к его ключевому атрибуту — Силе, поэтому Сила персонажа Джессики повышается до +3.
...
Когда Джессика применяет особенности своего класса, ей нужно определить несколько моментов. Сначала она записывает все свои начальные ранги мастерства, отмечая соответствующие поля в разделах Класса Брони, Спасброски, Владения оружием, Модификаторы атаки заклинанием и КС класса на своём листе.

Переходя к навыкам, Джессика отмечает Атлетику как тренированную, поскольку все соларианы тренированы в Атлетике. Затем она может выбрать ещё четыре навыка (если бы у её персонажа был более высокий Интеллект, она получила бы больше). Она проверяет, что все навыки, отмеченные на шагах 3 и 4, верно проставлены как тренированные. В итоге она выбирает Компьютеры, Акробатику, Оккультизм, Выживание и Воровство, отмечая их как тренированные. Далее она добавляет 10 Очков Здоровья от класса солариана и модификатор Телосложения +3 к 10 Очкам Здоровья от родословной ширрен, получая впечатляющие 23 Очка Здоровья в сумме.

Переходя к особенностям класса, Джессика отмечает свои [[character-creation/all-classes-content/all-classes/solarian#Солнечные проявления (Solar Manifestations)|солнечные проявления]]. В качестве [[character-creation/all-classes-content/all-classes-options/solar-weapon|солнечного оружия]] она выбирает алебарду и записывает её гравитонную и фотонную формы в раздел Ударов ближнего боя, указывая признак «[[rules/traits/reach|Досягаемость]]». Затем она записывает гравитонную и фотонную формы своей [[character-creation/all-classes-content/all-classes-options/solar-flare|Солнечной вспышки (Solar Flare)]] в раздел Ударов дальнего боя. После этого она вносит реакцию «[[rules/activities/all-activities/nimbus-surge|Всплеск нимба (Nimbus Surge) ↩]]» в раздел Свободных действий и Реакций на листе персонажа. В качестве способности она выбирает «[[feats/all-feats/stellar-rush|Звёздный натиск (Stellar Rush) ◆◆]]» и отмечает её в разделе способностей.

### Шаг 8

Далее Джессика переходит к Главе 6: Снаряжение. Она тренирована в ношении средней брони и выбирает [[equipment/all-equipment/all-armor/freebooter-armor|коммерческую броню флибустьера]] (в которую, как и в большинство видов брони, встроен [[equipment/all-equipment/all-items/comm-unit|коммуникатор]]). Что касается оружия, она знает, что может полагаться на свои солнечные проявления, но берёт в качестве запасного оружия [[equipment/all-equipment/all-weapons/semi-auto-pistol|коммерческий полуавтоматический пистолет]], так как у него больше дальность, а также 5 дополнительных зарядов боеприпасов, чтобы держать его заряженным. Она также [[equipment/all-equipment/all-items/hacking-toolkit|Хакерский комплект (Hacking Toolkit)]] и [[equipment/all-equipment/all-items/infiltrators-toolkit|Комплект взломщика (Infiltrator's Toolkit)]]. Все эти предметы она записывает в свой лист персонажа. Полуавтоматический пистолет она вносит в раздел Ударов дальнего боя. Остальное снаряжение она записывает в раздел Инвентаря на второй странице, вместе с кредитами, оставшимися после покупки стартового снаряжения. (Она надеется, что кофе в космосе не слишком дорогой!)
...
Джессика заполняет финальные детали своего персонажа, рассчитывая КБ и [[rules/player core/chapter-6-equipment#Ограничения Массы (Bulk Limits)|ограничения Массы]]. Наконец, она добавляет несколько последних штрихов к истории своего персонажа и решает назвать его Зази. Теперь ширрен-соларианка готова к своему первому приключению!

# Повышение уровня (Leveling Up)

С каждым побеждённым чудовищем и обезвреженной смертельной ловушкой персонаж зарабатывает Очки Опыта (ОО), которые позволяют ему повышать уровень. Каждый уровень дает лучшие навыки, увеличивает [[rules/player core/chapter-8-playing-the-game#Сопротивление (Resistance)|сопротивления]], и дает новые возможности, которые позволяют вашему персонажу столкнуться еще большими испытаниями и получить лучшие награды.
...
Вы можете найти все новые способности, уникальные для вашего класса, включая  способности класса, прямо в описании класса, хотя способности класса можно также использовать, чтобы получить [[rules/traits/archetype|архетип]]. В описании класса также объясняется, как применять повышения атрибутов и улучшения навыков, которые получает ваш персонаж. Если он получает способность родословной, вернитесь к описанию родословной вашего персонажа в [[rules/player core/chapter-2-ancestries-and-backgrounds|главе 2]] и выберите ещё одну способность родословной из списка. Если он получает улучшение навыка, обратитесь к [[rules/player core/chapter-4-skills|Главе 4]], чтобы решить, к какому навыку его применить. Если он получает общую способность или способность навыка, вы можете выбрать из списка способностей в [[rules/player core/chapter-5-feats|Главе 5]]. Если он может сотворять заклинания, см. описание класса для деталей о добавлении слотов и заклинаний. Также полезно пересмотреть заклинания персонажа в [[rules/player core/chapter-7-spells|Главе 7]] и проверить, нет ли у них [[rules/player core/chapter-7-spells#Усиленные заклинания (Heightened Spells)|усиленных]] версий, которые теперь можно сотворять.

После того как вы сделаете все выборы для нового уровня персонажа, обязательно просмотрите его лист и скорректируйте все изменившиеся значения. Как минимум, все бонусы мастерства, в которых персонаж тренирован или выше, увеличиваются на 1, так как он получил уровень, поэтому его КБ, броски атаки, Восприятие, спасброски, модификаторы навыков, КС заклинаний и КС класса увеличиваются как минимум на 1. Возможно, придётся изменить и другие значения из-за улучшений навыков, повышений атрибутов или особенностей класса, которые повышают ранг мастерства или другие показатели на определённых уровнях. Если повышение атрибута увеличивает модификатор Телосложения персонажа, пересчитайте его максимальные Очки Здоровья, используя новый модификатор Телосложения (обычно это добавляет 1 Очко Здоровья за уровень). Если повышение атрибута увеличивает модификатор Интеллекта, персонаж становится тренирован в дополнительном навыке и языке. Некоторые способности дают эффект, зависящий от уровня, например, Выносливость, и эти эффекты также корректируются каждый раз при получении нового уровня.

Вы можете выполнять шаги процесса повышения уровня в любом порядке. Например, если вы хотите взять способность навыка «[[feats/all-feats/intimidating-prowess|Выдающееся запугивание (Intimidating Prowess)]]» на 10-м уровне, но модификатор Силы вашего персонажа равен всего +2, вы можете сначала повысить модификатор Силы до +3 с помощью повышений атрибутов, получаемых на 10-м уровне, а затем на этом же уровне взять «[[feats/all-feats/intimidating-prowess|Выдающееся запугивание (Intimidating Prowess)]]» как способность навыка.
...
- Выбрали способности, указанные в таблице развития класса. Для способностей родословной см. [[rules/player core/chapter-2-ancestries-and-backgrounds|главу 2]]. Для способностей класса — описание вашего класса в [[rules/player core/chapter-3-classes|главе 3]]. Для общих способностей и способностей навыков — [[rules/player core/chapter-5-feats|Главу 5]].
- Добавили заклинания и слоты заклинаний, если ваш класс умеет колдовать. Для заклинаний см. [[rules/player core/chapter-7-spells|Главу 7]].
...
События Starfinder происходят в далёком будущем, после [Эпохи Утраченных Пророчеств](https://pf2e-ru-translation.readthedocs.io/ru/latest/lost_omens/index.html), но в истории галактики есть Разрыв. Примерно 300 лет назад что-то стерло целую эпоху из памяти. Записи об этом забытом времени просто не существуют. Люди, пережившие Разрыв, испытали коллективную амнезию относительно его событий. Магия не может восстановить прерванную хронологию, и даже боги не раскрывают, что произошло. В этот неопределённый период, который мог длиться от нескольких лет до нескольких столетий, общества изменились, планета Голарион исчезла, а [[setting/planets/absalom-station|Станция Абсалом]] была построена со Звёздным Камнем в своём ядре. Спустя несколько лет в галактике появилась возможность путешествовать через Поток, и началась новая эра межзвёздных приключений.
...
- **Галактика связана.** Искатели приключений использовали магические двигатели и мощные заклинания для исследования галактики с древних времён, но такие путешествия были редкими до тех пор, пока бог [[setting/all-deities/triune|Триединый]] не открыл гиперпространственные перелёты через таинственный план бытия, известный как Поток. Преданные последователи Триединого создают магические маяки, называемые Потоковыми маяками, которые позволяют кораблям прокладывать путь в гиперпространстве и передавать сообщения на большие расстояния. Кораблю с Потоковым двигателем требуется всего несколько дней или недель, чтобы преодолеть огромные межзвёздные расстояния. Линии Потока соединяют крупные порты, делая путешествия ещё быстрее, а поездки на Станцию Абсалом всегда быстры благодаря Звёздному Камню.
...
Ближний Космос — это термин, используемый в галактике для обозначения всех миров, близость которых к Потоковым маякам делает путешествия быстрыми и относительно безопасными. Связь, торговля и перемещения между планетами Ближнего Космоса являются обычным явлением. Когда после недавнего события, известного как Кризис Потока, открылись новые пути, к торговой сети Ближнего Космоса присоединились более удалённые миры.

В регионы Ближнего Космоса входят: Вескариум (Veskarium) — империя из семи завоёванных планет и нескольких десятков колоний, управляемых военными лидерами весков; Республика Марикса (Marixah Republic) — группа союзных планет, выходящих на галактическую арену; Гидеронское Владычество (Gideron Authority) — агрессивный режим, созданный изолированными колонистами, захватившими власть; Свободный союз Крейхолм (Kreiholm Freehold) — коалиция народов из далёкой системы Иссечённых Звёзд, объединившихся для взаимопомощи ещё много поколений назад; и Коллектив Сзандит (Szandite Collective) — федерация миров, объединённых древней магией.

## Простор (The Vast)

Опасные, редко посещаемые окраины галактики и бескрайние просторы неисследованного космоса за её пределами называются Простором. Лишь горстка разбросанных Потоковых маяков направляет корабли через Простор, и за пределами галактического края известно совсем немного ориентиров. Путешествия к захолустным колониям, удалённым горнодобывающим станциям и изоляционистским империям Простора опасны и медленны.

Регионы Простора включают: Звёздную Империю Ацланти (Azlanti Star Empire) — обширную территорию неизвестных размеров, контролируемую колонизаторским режимом, управляемым потомками человеческой нации с утраченного Голариона; Абсурдность Казмурга (Kazmurg's Absurdity) — недавно открытый сектор космоса, изломанный древней магией и наполненный новыми возможностями; Лайджок (Lajok) — родной мир ==влак (vlaka)== с таинственными руинами на орбите возрождённого солнца; и Иссечённые Звёзды (Scoured Stars) — тройную звёздную систему, которой правит ревнивый бог Кадрикал (Kadrical) и его джинсульские слуги.

# Религия (Religion)

Технологии и научные знания процветают по всей галактике, но эти достижения не могут решить все проблемы или ответить на все экзистенциальные вопросы. Многие обращаются к религии, чтобы понять своё место в космосе. Одни поклоняются божеству предков, другие следуют учениям пантеона, находят смысл в неверующем культе вроде [[setting/all-deities/green-faith|Зелёной Веры]] или придерживаются философии, такой как [[setting/all-deities/the-cycle|Цикл]]. Вера часто играет важную роль для [[character-creation/all-classes-content/all-classes/mystic|мистиков]], которые порой черпают свои способности из связи с божественным, и для [[character-creation/all-classes-content/all-classes/solarian|солариан]], находящих силу в понимании космического цикла. Стоит отметить, что во многих мирах мультивселенной существует бесчисленное множество божеств, религий и философий, помимо описанных в разделе [[setting/deities|Божества (Deities)]].

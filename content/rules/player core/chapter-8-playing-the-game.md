...
==Ослеплен (Dazzled)==: Для вас все является скрытым.
==Глухота (Deafened)==: Вы не можете слышать.
==Обречен (Doomed)==: Ваша душа в опасности, и вы теперь ближе к смерти.
...
==Ошеломлен (Stunned)==: Вы не можете использовать действия.

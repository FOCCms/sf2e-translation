...
По мере модернизации броня, щиты и оружие получают больше слотов улучшений. Высшие градации брони увеличивают Класс Брони и дают признак "стойкий" (resilient), улучшающий спасброски их владельца на указанное значение. Высшие градации оружия имеют увеличенные кости урона и получают признак [[rules/traits/tracking|наведение]], повышающий их броски атаки на указанное значение. Высшие градации щитов обладают увеличенной Прочностью, Очками Здоровья и ПП (Предел Поломки).
...
Например, если Чк Чк хочет модернизировать свою коммерческую [[equipment/all-equipment/all-weapons/painglaive|Боль-глефа (Painglaive)]] до тактической боль-глефы, КС будет равен 16, а стоимость составит 350 УПО для завершения за 1 день. Если он использует [[rules/player core/chapter-6-equipment#Формулы (Formulas)|формулу]], он может потратить один или несколько дней на создание, чтобы снизить стоимость УПО с помощью активности [[rules/activities/all-activities/craft|Создать (Craft)]], до половины (175 УПО), как обычно. Чк Чк может модернизировать свою коммерческую боль-глефу до улучшенной боль-глефы за один день при помощи проверки Ремесла с КС 19 и стоимости 650 УПО, но при этом он всё равно сможет снизить стоимость только на 175 УПО.
...
==Поднять щит (Raise a Shield)== — это действие, наиболее часто используемое со щитами. Большинство щитов необходимо держать в одной руке, поэтому вы не можете держать что-либо в этой руке и одновременно ==Поднять щит (Raise a Shield)==, и вы теряете его преимущества, если эта рука больше не свободна. ==Компактный щит== и ==лепестковый щит== не занимают руку, поэтому вы можете ==Поднять щит (Raise a Shield)== с таким щитом, если рука свободна или держит лёгкий предмет, который не является оружием. Вы теряете преимущества действия ==Поднять щит (Raise a Shield)==, если эта рука больше не соответствует этим условиям. ==Лепестковые щиты== и ==фазовые щиты== считаются щитами только в развёрнутом виде, как указано в их описании. Вы не можете ==Поднять щит (Raise a Shield)== с ==лепестковым== или ==фазовым== щитом, если он не развёрнут.
...
Некоторые драгоценные материалы доступны только в определённых градациях. Например, ==адамантин (adamantine)== не может быть низкой градации, а ==орихалк (orichalcum)== должен быть высокой градации. Предметы, изготовленные из материалов с более низкой градацией, чем ожидается для уровня предмета, или с более высокой градацией, чем необходимо, будут указывать градацию драгоценного материала.

...
Защитные системы доспеха работают количество дней, равное его уровню предмета. Активация или деактивация этих систем занимает одно действие ==Взаимодействовать (Interact)==, если вы носите доспех. Активация защитных систем на доспехе, надетом на согласное существо, занимает 2 действия и имеет признак "манипуляция" (manipulate). Благодаря встроенным системам безопасности вы не можете отключить защитные системы доспеха на существе против его воли.

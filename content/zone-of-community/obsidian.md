...
Затем распаковать архив в любое удобное место и в обсидиан открыть папку <путь до распакованного архива>/contents как хранилище. Обязательно выберите папку contents, а не всё целиком иначе! В противном случае хранилище будет работать некорректно.
